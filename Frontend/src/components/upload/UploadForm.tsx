...
export const UploadForm = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full">
      {!file && (
        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-3/6 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
